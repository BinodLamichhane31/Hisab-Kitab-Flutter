...
// Reusable Transaction List Widget for Customer and Supplier Views
class FilteredTransactionsList extends StatefulWidget {
  final String shopId;
  ...
  @override
  State<FilteredTransactionsList> createState() =>
      _FilteredTransactionsListState();
}

class _FilteredTransactionsListState extends State<FilteredTransactionsList> {
  final _searchController = TextEditingController();
  final _scrollController = ScrollController();
        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final transaction = state.transactions[index];
              return _FilteredTransactionTile(
...
class _FilteredTransactionTile extends StatelessWidget {
  final TransactionEntity transaction;
  final String? customerName;
  final String? supplierName;

  const _FilteredTransactionTile({
  ...
  Widget build(BuildContext context) {
    ...
    if (customerName != null) {
      title =
          isCashIn ? 'Payment from $customerName' : 'Payment to $customerName';
    } else if (supplierName != null) {
      title =
          isCashIn ? 'Payment from $supplierName' : 'Payment to $supplierName';
    }
